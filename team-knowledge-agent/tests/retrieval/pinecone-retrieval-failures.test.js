...
describe("Retrieval Pinecone Failures", () => {
    ...
    it("surfaces Pinecone query failures during retrieval", async () => {
        ...
        await expect(queryKnowledge("Where is the onboarding checklist?")).rejects.toThrow("Pinecone retrieval failed");
    });
});
//# sourceMappingURL=pinecone-retrieval-failures.test.js.map